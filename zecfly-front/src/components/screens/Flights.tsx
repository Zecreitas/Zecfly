...
const Flights: React.FC = () => {
  ...
  const handlePriceChange = (type: 'min' | 'max', value: number) => {
    // Atualizar o estado do preço
    setPriceRange(prev => {
      const newRange = { ...prev, [type]: value };
      // Aplicar os filtros imediatamente com o novo valor
      applyFilters(originalFlights.filter(flight => {
        const price = parseFloat(flight.price.total);
            ...
            {loading ? (
              ...
              <div className="space-y-6">
                {filteredFlights.map((flight) => (
                  <div key={flight.id} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all p-6 border border-gray-100">
                    <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between">
                        ...
                        <div className="flex items-center mb-4">
                          ...
                          <div>
                            <div className="font-semibold text-gray-900">
                              {airlineNames[flight.itineraries[0].segments[0].carrierCode] || flight.itineraries[0].segments[0].carrierCode}
                            </div>
                            <div className="text-sm text-gray-500">Voo {flight.itineraries[0].segments[0].number}</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="text-center">
                            <div className="text-2xl font-bold text-gray-900">
                              {new Date(flight.itineraries[0].segments[0].departure.at).toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' })}
                            </div>
                            ...
                            <div className="flex items-center justify-center">
                              ...
                              <div className="mx-4 text-center">
                                ...
                                <div className="text-xs text-green-600 font-medium">
                                  {flight.itineraries[0].segments.length === 1 ? 'Direto' : `${flight.itineraries[0].segments.length - 1} escala(s)`}
                                </div>
                              </div>
                              <div className="flex-1 h-px bg-gray-300"></div>
                            </div>
                          ...
                          <div className="text-center">
                            <div className="text-2xl font-bold text-gray-900">
                              {new Date(flight.itineraries[0].segments[0].arrival.at).toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' })}
                            </div>
                      ...
                      <div className="mt-6 lg:mt-0 lg:ml-6 lg:text-right">
                        ...
                        <div className="text-sm text-gray-500">por passageiro</div>
                        <button 
                          className="mt-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-3 rounded-xl font-semibold hover:shadow-lg transition-all transform hover:scale-105 inline-flex items-center gap-2"
                          aria-label={`Selecionar voo ${flight.itineraries[0].segments[0].number} por ${flight.price.total} ${flight.price.currency}`}
                        >
                          Selecionar
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                Sua plataforma confiável para encontrar e reservar os melhores voos com os melhores preços.
              </p>
