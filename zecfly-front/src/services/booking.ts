...
const RAPIDAPI_KEY = '560b57a0ddmshef4cf040acd85bbp1e2097jsn48186bd245d4';
...
export const bookingService = {
  searchHotels: async (params: BookingSearchParams): Promise<BookingResponse> => {
    try {
      const response = await bookingApi.get('/properties/list-by-map', { params });
